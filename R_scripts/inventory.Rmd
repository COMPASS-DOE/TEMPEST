...
inv %>%
    ...
    left_join(inv_long_growth, by = c("Plot", "Section", "Tag", "Grid", "Species_code", "Year")) %>%
    left_join(inv_long_resurrect, by = c("Plot", "Section", "Tag", "Grid", "Species_code", "Year")) %>%
    left_join(inv_long_zombie, by = c("Plot", "Section", "Tag", "Grid", "Species_code", "Year")) %>%
...
ggplot(inv_long, aes(DBH, Growth, color = Genus)) +
    ...
    ggtitle("DBH versus growth (extreme values not shown)") +
    facet_wrap(~Year)
