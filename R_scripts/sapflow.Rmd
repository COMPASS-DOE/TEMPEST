...
```{r}
p_md %+% filter(sapflow, Logger == "11") %+% labs(title = "Logger: 11")

p_md %+% filter(sapflow, Logger == "12") %+% labs(title = "Logger: 13")

p_md %+% filter(sapflow, Logger == "13") %+% labs(title = "Logger: 13")
```

### Fresh

```{r}
p_md %+% filter(sapflow, Logger == "31") %+% labs(title = "Logger: 31")

p_md %+% filter(sapflow, Logger == "32") %+% labs(title = "Logger: 32")

p_md %+% filter(sapflow, Logger == "33") %+% labs(title = "Logger: 33")
```

### Salt

```{r}
p_md %+% filter(sapflow, Logger == "21") %+% labs(title = "Logger: 21")

p_md %+% filter(sapflow, Logger == "22") %+% labs(title = "Logger: 22")

p_md %+% filter(sapflow, Logger == "23") %+% labs(title = "Logger: 23")
```

### Shore

```{r}
p_md %+% filter(sapflow, Plot == "L")
```
...
# 
# sapflow %>%
#     group_by(Date, Tree_Code) %>%
#     do(compute_rle(.)) %>%
#     print()


# ggplot(reps_logger, aes(x = Date, y = Average, group = Logger, color = Is_old)) +
#     geom_line() +
