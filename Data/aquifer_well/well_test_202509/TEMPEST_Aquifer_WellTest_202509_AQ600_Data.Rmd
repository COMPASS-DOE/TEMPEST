...
well_dat <- read.csv("Raw Data/COMPASS_TEMPEST_WellTest_AQ600_Data.csv")
#head(well_dat)
...
#plot TDS 
pH <- ggplot()+
  geom_point(data=well_dat_filtered, aes(x=Date_Time, y=pH), size=2, color="darkviolet")+ 
  theme_bw()+ labs(x="Time", y="pH ", title="Aquifer pH") + theme(legend.title = element_blank())
