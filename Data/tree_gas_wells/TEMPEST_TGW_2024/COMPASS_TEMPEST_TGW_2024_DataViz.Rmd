...
april_may <- read.csv("2024 Processed Data/COMPASS_TEMPEST_TGW_202404-05_Processed.csv", colClasses = "character")
july_aug <- read.csv("2024 Processed Data/COMPASS_TEMPEST_TGW_202407-08_Processed.csv", colClasses = "character")
sept_oct <- read.csv("2024 Processed Data/COMPASS_TEMPEST_TGW_202409-10_Processed.csv", colClasses = "character")
nov <- read.csv("2024 Processed Data/COMPASS_TEMPEST_TGW_202411_Processed.csv", colClasses = "character")
...
june1 <- read.csv("2024 Processed Data/COMPASS_TEMPEST_TGW_202406-D1PM-D2AM_Processed.csv", colClasses = "character")
june2 <- read.csv("2024 Processed Data/COMPASS_TEMPEST_TGW_202406-D2PM-D3AM_Processed.csv", colClasses = "character")
june3 <- read.csv("2024 Processed Data/COMPASS_TEMPEST_TGW_202406-D3PM-D4AM_Processed.csv", colClasses = "character")
june4 <- read.csv("2024 Processed Data/COMPASS_TEMPEST_TGW_202406-D4PM-D5AM_Processed.csv", colClasses = "character")
june5 <- read.csv("2024 Processed Data/COMPASS_TEMPEST_TGW_202406-D5PM_Processed.csv", colClasses = "character")
...
alldat <- bind_rows(april_may, june1, june2, june3, june4, june5, july_aug, sept_oct, nov )
head(alldat)
