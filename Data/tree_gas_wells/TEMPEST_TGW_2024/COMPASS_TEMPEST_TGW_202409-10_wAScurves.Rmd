---
title: "COMPASS_TEMPEST_TGW_202409_10"
...
#Read in  Data 
raw <- read.csv("2024 Raw Data/TEMPEST_TGW_MM_202409-10_entered.csv")
head(raw)
...
Slopes$Run_Date <- c(20241204, 20241204, 20241204)
...
#Samples1 <- Samples[ ,c(1:3,6:17,21, 26:33)]
#head(Samples1)

#write out the data to a csv in the processed data folder
#write.csv(Samples1, "2024 Processed Data/COMPASS_TEMPEST_SGW_202404-05_Processed.csv")
