...
#Read in  Data 
raw <- read.csv("2024 Raw Data/TEMPEST_TGW_MM_202407-08_entered_wMMcurves.csv")
head(raw)
...
Samples1 <- Samples[ ,c(1:3,6:17,21:22, 26:33)]
#head(Samples1)

#write out the data to a csv in the processed data folder
write.csv(Samples1, "2024 Processed Data/COMPASS_TEMPEST_TGW_202407-08_Processed.csv")
