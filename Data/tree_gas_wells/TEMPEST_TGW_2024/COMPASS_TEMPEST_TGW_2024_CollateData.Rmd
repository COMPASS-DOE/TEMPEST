---
title: "COMPASS_TEMPEST_TGW_2024_CollateData"
...
```{r}
#read in all data: 
dat <- read.csv("2024 Processed Data/TEMPEST_TGW_2024_AllData.csv")
head(dat)
...
final <- dat1 %>%
  select( "Project", "Year","Month" , "Day", "Time","Time_Zone", "Event_Stamp", "Plot", "Sapflux_Tree_ID", 
          "Sample_Grid", "Sample_ID", "Field_Notes", "Lab_Notes", "Sample_Matrix", 
...
write.csv(final, "COMPASS_TEMPEST_TGW_2024_AllData.csv")
...
write.csv(syn_dat, "2024 Processed Data/COMPASS_SynopticCB_GCW_UP_TGAS_2024.csv")
