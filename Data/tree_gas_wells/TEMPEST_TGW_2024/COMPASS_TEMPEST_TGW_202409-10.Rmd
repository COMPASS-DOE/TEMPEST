...
#Read in  Data 
raw <- read.csv("2024 Raw Data/TEMPEST_TGW_MM_202409-10_entered_wMMcurves.csv")
head(raw)
...
Slopes$Run_Date <- c(20241126, 20241126, 20241126)
...
write.csv(Samples1, "2024 Processed Data/COMPASS_TEMPEST_TGW_202409-10_Processed.csv")
