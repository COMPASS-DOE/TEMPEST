---
title: "COMPASS_TEMPEST_TGW_202406: TMP-III D2PM & D3AM"
...
#Read in  Data 
raw <- read.csv("2024 Raw Data/TEMPEST_TGW_Event_D2PM_D3AM_202406_entered.csv")
head(raw)
...
Slopes$Run_Date <- c(20240916, 20240916, 20240916)
...
Samples1 <- Samples[ ,c(1:3,6:17,21, 23, 26:29)]
#head(Samples1)

#write out the data to a csv in the processed data folder
write.csv(Samples1, "2024 Processed Data/COMPASS_TEMPEST_TGW_202406-D2PM-D3AM_Processed.csv")
