...
#Read in  Data 
raw <- read.csv("2024 Raw Data/TEMPEST_TGW_Event_D3PM_D4AM_202406_entered_wMMcurves.csv")
head(raw)

#pull out methane standards
stds_ch4 <-  raw %>%  
   filter(str_detect(User, "Wegner")) %>% 
...
Slopes$Run_Date <- c(20241029, 20241029, 20241029)
