...
#Read in  Data 
raw <- read.csv("2023 Raw Data/TEMPEST_TGW_202306_T2-3am.csv")
head(raw)
...
Slopes$Run_Date <- c(202306.2, 202306.2, 202306.2)
...
write.csv(Samples1, "2023 Processed Data/COMPASS_TEMPEST_TGW_202306_T2-3am_Processed.csv")
