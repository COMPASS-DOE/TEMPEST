...
#Read in Data 
raw <- read.csv("2023 Raw Data/TEMPEST_TGW_202306_T3pm-4.csv")
head(raw)
...
Slopes$Run_Date <- c(202306.5, 202306.5, 202306.5)
...
ch4_samples1 <-  ggplot(data = Samples, aes(x = Sample_ID, y = CH4_Conc_nmol, fill=G_W)) +
       geom_bar(stat = 'identity') + 
        scale_fill_manual(values=c("purple","darkgrey", "darkblue"))+
...
Samples1 <- Samples[ ,c(1:3,6:18,22:23, 27:30)]
#head(Samples1)


write.csv(Samples1, "2023 Processed Data/COMPASS_TEMPEST_TGW_202306_T3pm-4_Processed.csv")
