---
title: "COMPASS_TEMPEST_TGW_2023: March, May"
...
```{r , echo=FALSE}
#Read inData 
raw <- read.csv("2023 Raw Data/TEMPEST_TGAS_202303_05_entered.csv")
head(raw)
...
Samples1 <- Samples[ ,c(1:3,6:17,21:22, 26:29)]
head(Samples1)

write.csv(Samples1, "2023 Processed Data/COMPASS_TEMPEST_TGW_202303_05_Processed.csv")
