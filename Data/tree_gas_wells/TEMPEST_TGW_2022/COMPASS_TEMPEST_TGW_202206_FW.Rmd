---
title: "COMPASS_TEMPEST_TGW_2022: June: FW"
...
```{r , echo=FALSE}
#Read in Data 
raw <- read.csv("2022 Raw Data/TEMPEST_TGW_FW_202206.csv")
head(raw)
...
Slopes$Run_Date <- c(202206.5, 202206.5, 202206.5)
...
write.csv(Samples1, "2022 Processed Data/COMPASS_TEMPEST_TGW_202206_FW_Processed.csv")
