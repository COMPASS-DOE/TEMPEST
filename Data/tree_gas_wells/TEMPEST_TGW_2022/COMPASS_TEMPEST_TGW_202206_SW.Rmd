---
title: "COMPASS_TEMPEST_TGW_2022: June: SW"
...
#Read in Data 
raw <- read.csv("2022 Raw Data/TEMPEST_TGW_SW_202206.csv")
head(raw)
...
Slopes$Run_Date <- c(202206.8, 202206.8, 202206.8)

log <- read.csv("2022 Raw Data/COMPASS_TEMPEST_Varian_TGAS_QAQC_2022.csv")
head(log)
log <- log[ ,-c(1)]
...
write.csv(log, "2022 Raw Data/COMPASS_TEMPEST_Varian_TGAS_QAQC_2022.csv")
```
...
write.csv(Samples1, "2022 Processed Data/COMPASS_TEMPEST_TGW_202206_SW_Processed.csv")
