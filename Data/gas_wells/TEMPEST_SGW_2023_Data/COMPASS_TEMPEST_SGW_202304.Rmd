...
```{r , echo=FALSE}
#Read in June Data 
raw <- read.csv("2023 Raw Data/TEMPEST_SGAS_April_2023_entered.csv")
head(raw)
...
Samples1 <- Samples[ ,c(1:3,6:16,20, 24:29)]
#head(Samples1)

write.csv(Samples1, "2023 Processed Data/COMPASS_TEMPEST_SGW_202304_Processed.csv")
