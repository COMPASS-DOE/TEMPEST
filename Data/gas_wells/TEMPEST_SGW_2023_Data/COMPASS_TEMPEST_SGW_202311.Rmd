---
title: "COMPASS_TEMPEST_SGW_2023: November"
...
#Read in Nov Data 
raw <- read.csv("2023 Raw Data/TEMPEST_SGAS_Nov_2023_entered.csv")
head(raw)
...
log <- read.csv("2023 Raw Data/COMPASS_TEMPEST_Varian_QAQC_2023.csv")
head(log)
log <- log[ ,-c(1)]
...
write.csv(log, "2023 Raw Data/COMPASS_TEMPEST_Varian_QAQC_2023.csv")
```
...
write.csv(Samples1, "2023 Processed Data/COMPASS_TEMPEST_SGW_202311_Processed.csv")
