...
#Read in Oct Data 
raw <- read.csv("2023 Raw Data/TEMPEST_SGAS_Oct_2023_entered_SW.csv")
head(raw)
...
Samples1 <- Samples1 %>% 
  rename(Field_Notes = Field_.Notes)

write.csv(Samples1, "2023 Processed Data/COMPASS_TEMPEST_SGW_202310_Processed.csv")
