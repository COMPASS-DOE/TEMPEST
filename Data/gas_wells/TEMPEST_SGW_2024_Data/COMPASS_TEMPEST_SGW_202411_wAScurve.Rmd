...
```{r , echo=FALSE}
#Read in June Data 
raw <- read.csv("2024 Raw Data/TEMPEST_SGW_MM_202411_entered.csv")
head(raw)
...
#write.csv(Samples1, "COMPASS_TEMPEST_SGW_202410_Processed.csv")  #not writing out because curve is bad!!!!
