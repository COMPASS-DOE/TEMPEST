...
## Read in first data file and assess standard curves 
    ## Standard curve run with this run had standards that were not prepared properly (over pressurized)
    ## We have brought in the curve run most recently to this run that was prepared correctly for analysis
```{r , echo=FALSE}
#Read in June Data 
raw <- read.csv("2024 Raw Data/TEMPEST_SGW_MM_202409_entered_wMWcurve.csv") 
head(raw)
...
Slopes$Run_Date <- c(202409.5, 202409.5, 202409.5)
...
write.csv(Samples1, "2024 Processed Data/COMPASS_TEMPEST_SGW_202409_Processed.csv")
