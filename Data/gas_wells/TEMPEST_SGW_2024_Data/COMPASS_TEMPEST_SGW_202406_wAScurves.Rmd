...
#Read in June Data 
raw <- read.csv("2024 Raw Data/TEMPEST_SGAS_202406_ALL_entered.csv")
head(raw)
...
## Write out processed data & slopes  - NOT DONE HERE 
```{r}
...
#write.csv(Samples1, "COMPASS_TEMPEST_SGW_202306_Processeda.csv")
