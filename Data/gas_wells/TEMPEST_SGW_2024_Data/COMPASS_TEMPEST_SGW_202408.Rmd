...
```{r , echo=FALSE}
#Read in June Data 
raw <- read.csv("2024 Raw Data/TEMPEST_SGW_MM_202408_entered_wMWcurve.csv")
head(raw)
...
Slopes$Run_Date <- c(202408.5, 202408.5, 202408.5)
...
write.csv(Samples1, "2024 Processed Data/COMPASS_TEMPEST_SGW_202408_Processed.csv")
