---
title: "COMPASS_TEMPEST_SGW_2023: June & TMP III"
...
#Read in June Data 
raw <- read.csv("2024 Raw Data/TEMPEST_SGAS_202406_ALL_entered_wMWcurves.csv")
head(raw)
...
Slopes$Run_Date <- c(202406.5, 202406.5, 202406.5)
...
Samples1 <- Samples[ ,c(1:3,6:17,21, 24:33)]
#head(Samples1)
...
write.csv(Samples1, "2024 Processed Data/COMPASS_TEMPEST_SGW_202406_Processed.csv")
