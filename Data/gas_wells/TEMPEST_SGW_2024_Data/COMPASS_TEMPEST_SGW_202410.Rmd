...
```{r , echo=FALSE}
#Read in June Data 
raw <- read.csv("2024 Raw Data/TEMPEST_SGW_MM_202410_entered_wMWcurve.csv") 
head(raw)
...
Slopes$Run_Date <- c(202410.5, 202410.5, 202410.5)
...
write.csv(Samples1, "2024 Processed Data/COMPASS_TEMPEST_SGW_202410_Processed.csv")
