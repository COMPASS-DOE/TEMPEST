...
Samples2 <- left_join(Samples, Exp_Conc, by = c("Sample_ID" = "Standard"))

Samples2 <- Samples2 %>% 
  select(Sample_ID, CO2_Conc_ppm, CH4_Conc_ppm, CO2_Conc_Exp, CH4_Conc_Exp)
...
##Put Samples in Order and Plot in Order
```{r}
